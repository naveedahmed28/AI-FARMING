...
public class AdminActivity extends AppCompatActivity {
    ...
    SearchAdminAdapter searchAdapter;
                           ...
                           // Toast.makeText(MainActivity.this, ""+response, Toast.LENGTH_SHORT).show();
                            try {
                                ...
                                if (jsonArray.length() == 0) {
                                    Toast.makeText(AdminActivity.this, "No Data Found", Toast.LENGTH_LONG).show();
                                } else {
                                    ...
                                    try {
                                        ...
                                        searchAdapter = new SearchAdminAdapter(AdminActivity.this,disease,name,age,medicine);
