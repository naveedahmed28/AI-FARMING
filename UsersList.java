...
public class UsersList extends AppCompatActivity {
    ...
    UserAdminAdapter searchAdapter;
    ProgressDialog progressDialog;
    private static final String URL="https://wizzie.online/fertilizer/getUsers.php";
                           ...
                           // Toast.makeText(MainActivity.this, ""+response, Toast.LENGTH_SHORT).show();
                            try {
                                ...
                                if (jsonArray.length() == 0) {
                                    Toast.makeText(UsersList.this, "No Data Found", Toast.LENGTH_LONG).show();
                                } else {
                                    ...
                                    try {
                                        for (int i = 0; i < jsonArray.length(); i++) {
                                            ...
                                            age.add(jsonObject.getString("email"));
                                            disease.add(jsonObject.getString("no"));
                                            medicine.add(jsonObject.getString("type"));
                                        ...
                                        searchAdapter = new UserAdminAdapter(UsersList.this,disease,name,age,medicine);
