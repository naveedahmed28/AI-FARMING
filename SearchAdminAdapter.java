...
public class SearchAdminAdapter extends RecyclerView.Adapter<SearchAdminAdapter.ViewHolder> {
    ...
    public SearchAdminAdapter(AdminActivity mainActivity, ArrayList disease, ArrayList name, ArrayList age, ArrayList medicine) {
