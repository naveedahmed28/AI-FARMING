...
public class Pay extends AppCompatActivity {
    ...
    void initializeViews() {
        ...
        amountEt.setText(getIntent().getStringExtra("payment"));
    ...
    private void upiPaymentDataOperation(ArrayList<String> data) {
        if (isConnectionAvailable(Pay.this)) {
            ...
            status_update("Paid",getIntent().getStringExtra("orderid"));
                //Code to handle successful transaction here.
                Toast.makeText(Pay.this, "Transaction successful.", Toast.LENGTH_SHORT).show();
                Log.d("UPI", "responseStr: "+approvalRefNo);
            }
            else if("Payment cancelled by user.".equals(paymentCancel)) {
                status_update("Payment Cancelled",getIntent().getStringExtra("orderid"));
                Toast.makeText(Pay.this, "Payment cancelled by user.", Toast.LENGTH_SHORT).show();
            }
            else {
                status_update("Payment Failed",getIntent().getStringExtra("orderid"));
    ...
    private void status_update(String status,String orderid){
        ProgressDialog dialog=new ProgressDialog(this);
                dialog.setCancelable(false);
                dialog.setTitle("Loading........");
                dialog.show();
        StringRequest strin=new StringRequest(Request.Method.POST,"https://wizzie.online/fertilizer/newfile/payment.php", response -> {
            dialog.dismiss();
