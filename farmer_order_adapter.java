...
public class farmer_order_adapter extends RecyclerView.Adapter<admin_order_holder> {

    Context c;
    ArrayList<farmer_order> list;
    RequestQueue mQueue;

    public farmer_order_adapter(Context c, ArrayList<farmer_order> list) {
        this.c = c;
        this.list = list;
    ...
    public admin_order_holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.farmer_order_card,parent,false);
    ...
    public void onBindViewHolder(@NonNull final admin_order_holder holder, final int position) {
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = "https://wizzie.online/fertilizer/farmerdeleteorder.php";
        ...
        holder.done.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = "http://wizzie.tech/fertilizer/farmerupdateorder.php";
